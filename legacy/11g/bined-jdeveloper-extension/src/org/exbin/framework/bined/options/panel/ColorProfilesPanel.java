...
public class ColorProfilesPanel extends javax.swing.JPanel implements ProfileListPanel {
    ...
    public List<String> getProfileNames() {
        ...
        List<ColorProfile> themeProfiles = getProfilesListModel().profiles;
        for (ColorProfile profile : themeProfiles) {
    ...
    private void initComponents() {
        ...
        profilesList = new javax.swing.JList<ColorProfile>();
    ...
    private void addButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_addButtonActionPerformed
        final ProfilesListModel model = getProfilesListModel();
        final int selectedIndex = profilesList.getSelectedIndex();
        final ColorProfilePanel colorProfilePanel = new ColorProfilePanel();
        colorProfilePanel.setColorProfile(new ExtendedCodeAreaColorProfile());
        final NamedProfilePanel namedProfilePanel = new NamedProfilePanel(colorProfilePanel);
            ...
            public void controlActionPerformed(ControlActionType actionType) {
                if (actionType != DefaultControlHandler.ControlActionType.CANCEL) {
                    if (!isValidProfileName(namedProfilePanel.getProfileName())) {
                        JOptionPane.showMessageDialog(ColorProfilesPanel.this, "Invalid profile name", "Profile Editation Error", JOptionPane.ERROR_MESSAGE);
                        return;
                    }
    ...
    private void editButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_editButtonActionPerformed
        final ProfilesListModel model = getProfilesListModel();
        final int selectedIndex = profilesList.getSelectedIndex();
        final ColorProfile profileRecord = model.getElementAt(selectedIndex);
        final ColorProfilePanel colorProfilePanel = new ColorProfilePanel();
        final NamedProfilePanel namedProfilePanel = new NamedProfilePanel(colorProfilePanel);
        DefaultControlPanel controlPanel = new DefaultControlPanel();
        JPanel dialogPanel = WindowUtils.createDialogPanel(namedProfilePanel, controlPanel);
    ...
    public void loadFromOptions(CodeAreaColorOptionsImpl options) {
        ...
        List<ColorProfile> profiles = new ArrayList<ColorProfile>();
    ...
    private static final class ProfilesListModel extends AbstractListModel<ColorProfile> {
        ...
        private final List<ColorProfile> profiles = new ArrayList<ColorProfile>();
    ...
    private boolean hasProfileWithName(String profileName) {
        List<ColorProfile> profiles = getProfilesListModel().getProfiles();
        for (ColorProfile profile : profiles) {
