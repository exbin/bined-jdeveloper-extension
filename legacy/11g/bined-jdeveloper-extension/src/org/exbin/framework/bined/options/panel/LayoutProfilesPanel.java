...
public class LayoutProfilesPanel extends javax.swing.JPanel implements ProfileListPanel {
    ...
    public List<String> getProfileNames() {
        ...
        List<LayoutProfile> themeProfiles = getProfilesListModel().profiles;
        for (LayoutProfile profile : themeProfiles) {
    ...
    private void initComponents() {
        ...
        profilesList = new javax.swing.JList<LayoutProfile>();
    ...
    private void addButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_addButtonActionPerformed
        ...
        final LayoutProfilePanel layoutProfilePanel = new LayoutProfilePanel();
        layoutProfilePanel.setLayoutProfile(new DefaultExtendedCodeAreaLayoutProfile());
        final NamedProfilePanel namedProfilePanel = new NamedProfilePanel(layoutProfilePanel);
        ...
        controlPanel.setHandler(new DefaultControlHandler() {
            ...
            if (actionType != DefaultControlHandler.ControlActionType.CANCEL) {
                if (!isValidProfileName(namedProfilePanel.getProfileName())) {
                    JOptionPane.showMessageDialog(LayoutProfilesPanel.this, "Invalid profile name", "Profile Editation Error", JOptionPane.ERROR_MESSAGE);
                    return;
                }
    ...
    private void editButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_editButtonActionPerformed
        final ProfilesListModel model = getProfilesListModel();
        final int selectedIndex = profilesList.getSelectedIndex();
        final LayoutProfile profileRecord = model.getElementAt(selectedIndex);
        final LayoutProfilePanel layoutProfilePanel = new LayoutProfilePanel();
        final NamedProfilePanel namedProfilePanel = new NamedProfilePanel(layoutProfilePanel);
        DefaultControlPanel controlPanel = new DefaultControlPanel();
        JPanel dialogPanel = WindowUtils.createDialogPanel(namedProfilePanel, controlPanel);
...
//        activeOptions = options;
        ...
        List<LayoutProfile> profiles = new ArrayList<LayoutProfile>();
    ...
    private static final class ProfilesListModel extends AbstractListModel<LayoutProfile> {
        ...
        private final List<LayoutProfile> profiles = new ArrayList<LayoutProfile>();
    ...
    private boolean hasProfileWithName(String profileName) {
        List<LayoutProfile> profiles = getProfilesListModel().getProfiles();
