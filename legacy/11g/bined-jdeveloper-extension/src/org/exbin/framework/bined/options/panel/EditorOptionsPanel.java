...
public class EditorOptionsPanel extends javax.swing.JPanel implements OptionsCapable<EditorOptionsImpl> {
    ...
    private void initComponents() {
        ...
        fileHandlingModeComboBox = new javax.swing.JComboBox<String>();
        showValuesPanelCheckBox = new javax.swing.JCheckBox();
        enterKeyHandlingModeLabel = new javax.swing.JLabel();
        enterKeyHandlingModeComboBox = new javax.swing.JComboBox<String>();

        fileHandlingModeLabel.setText(resourceBundle.getString("fileHandlingModeLabel.text")); // NOI18N

        fileHandlingModeComboBox.setModel(new javax.swing.DefaultComboBoxModel<String>(new String[] { "DELTA", "MEMORY" }));
        ...
        enterKeyHandlingModeComboBox.setModel(new javax.swing.DefaultComboBoxModel<String>(new String[] { "PLATFORM_SPECIFIC", "CR", "LF", "CRLF", "IGNORE" }));
