...
public class StatusOptionsPanel extends javax.swing.JPanel implements OptionsCapable<StatusOptionsImpl> {
    ...
    public void saveToOptions(StatusOptionsImpl options) {
        ...
        options.setOctalSpaceGroupSize((Integer) octalGroupSizeSpinner.getValue());
        options.setDecimalSpaceGroupSize((Integer) decimalGroupSizeSpinner.getValue());
        options.setHexadecimalSpaceGroupSize((Integer) hexadecimalGroupSizeSpinner.getValue());
    }
    ...
    private void initComponents() {
        ...
        cursorPositionCodeTypeComboBox = new javax.swing.JComboBox<String>();
        cursorPositionShowOffsetCheckBox = new javax.swing.JCheckBox();
        documentSizeCodeTypeLabel = new javax.swing.JLabel();
        documentSizeCodeTypeComboBox = new javax.swing.JComboBox<String>();
        ...
        cursorPositionCodeTypeComboBox.setModel(new javax.swing.DefaultComboBoxModel<String>(new String[] { "OCTAL", "DECIMAL", "HEXADECIMAL" }));
        ...
        documentSizeCodeTypeComboBox.setModel(new javax.swing.DefaultComboBoxModel<String>(new String[] { "OCTAL", "DECIMAL", "HEXADECIMAL" }));
