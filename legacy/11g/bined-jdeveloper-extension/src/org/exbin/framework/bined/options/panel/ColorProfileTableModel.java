...
public class ColorProfileTableModel implements TableModel {
    ...
    private void notifyAllListeners(int rowNumber) {
        for (TableModelListener listener : listeners) {
            listener.tableChanged(new TableModelEvent(this, rowNumber, 1, TableModelEvent.UPDATE));
        }
    }

    private void notifyAllListeners() {
        for (TableModelListener listener : listeners) {
            listener.tableChanged(new TableModelEvent(this, 0, rows.size() - 1, 1, TableModelEvent.UPDATE));
        }
    }
