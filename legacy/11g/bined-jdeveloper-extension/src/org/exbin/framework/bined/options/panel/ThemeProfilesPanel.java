...
public class ThemeProfilesPanel extends javax.swing.JPanel implements ProfileListPanel {
    ...
    public List<String> getProfileNames() {
        ...
        List<ThemeProfile> themeProfiles = getProfilesListModel().profiles;
        for (ThemeProfile profile : themeProfiles) {
    ...
    private void initComponents() {
        ...
        profilesList = new javax.swing.JList<ThemeProfile>();
    ...
    private void addButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_addButtonActionPerformed
        ...
        final ThemeProfilePanel themeProfilePanel = new ThemeProfilePanel();
        themeProfilePanel.setThemeProfile(new ExtendedCodeAreaThemeProfile());
        final NamedProfilePanel namedProfilePanel = new NamedProfilePanel(themeProfilePanel);
                ...
                public void controlActionPerformed(ControlActionType actionType) {
                    if (actionType != DefaultControlHandler.ControlActionType.CANCEL) {
                        if (!isValidProfileName(namedProfilePanel.getProfileName())) {
                            JOptionPane.showMessageDialog(ThemeProfilesPanel.this, "Invalid profile name", "Profile Editation Error", JOptionPane.ERROR_MESSAGE);
                            return;
                        }
    ...
    private void editButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_editButtonActionPerformed
        final ProfilesListModel model = getProfilesListModel();
        final int selectedIndex = profilesList.getSelectedIndex();
        final ThemeProfile profileRecord = model.getElementAt(selectedIndex);
        final ThemeProfilePanel themeProfilePanel = new ThemeProfilePanel();
        final NamedProfilePanel namedProfilePanel = new NamedProfilePanel(themeProfilePanel);
        DefaultControlPanel controlPanel = new DefaultControlPanel();
        JPanel dialogPanel = WindowUtils.createDialogPanel(namedProfilePanel, controlPanel);
    ...
    private boolean hasProfileWithName(String profileName) {
        List<ThemeProfile> profiles = getProfilesListModel().getProfiles();
