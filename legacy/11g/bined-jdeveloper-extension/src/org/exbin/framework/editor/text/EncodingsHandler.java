...
import org.exbin.framework.editor.text.options.panel.TextEncodingPanel.AddEncodingsOperation;
...
public class EncodingsHandler {
    ...
    public void init() {
        ...
        utfEncodingActionListener = new ActionListener() {
                @Override
        ...
        manageEncodingsAction = new AbstractAction() {
            ...
            public void actionPerformed(ActionEvent e) {
                ...
                textEncodingPanel.setAddEncodingsOperation(new AddEncodingsOperation() {
                            @Override
