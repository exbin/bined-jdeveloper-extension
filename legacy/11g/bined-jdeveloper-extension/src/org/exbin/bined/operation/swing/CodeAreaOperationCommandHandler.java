...
public class CodeAreaOperationCommandHandler implements CodeAreaCommandHandler {
    ...
    public static CodeAreaCommandHandler.CodeAreaCommandHandlerFactory createDefaultCodeAreaCommandHandlerFactory() {
        return new CodeAreaCommandHandler.CodeAreaCommandHandlerFactory() {
            @Override
            public CodeAreaCommandHandler createCommandHandler(CodeAreaCore codeArea1) {
                return new CodeAreaOperationCommandHandler(codeArea1, new CodeAreaUndoHandler(codeArea1));
            }
        };
    }
