...
public class BinEdOptionsPanel extends javax.swing.JPanel implements BinEdApplyOptions {
    ...
    private DefaultListModel<CategoryItem> categoryModel = new DefaultListModel<CategoryItem>();
    ...
    public BinEdOptionsPanel() {
        ...
        encodingOptionsPanel.setAddEncodingsOperation(new TextEncodingPanel.AddEncodingsOperation() {
            ...
            public List<String> run(List<String> usedEncodings) {
                ...
                DefaultControlPanel encodingsControlPanel =
                    new DefaultControlPanel(addEncodingPanel.getResourceBundle());
                ...
                encodingsControlPanel.setHandler(new DefaultControlHandler() {
                    @Override
    ...
    private void initComponents() {
        ...
        categoriesList = new javax.swing.JList<CategoryItem>();
