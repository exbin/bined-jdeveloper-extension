...
public class BinEdFileEditor extends Editor {
    ...
    public BinEdFileEditor() {
        ...
        toolbarPanel.setSaveAction(new ActionListener() {
            @Override
    ...
    public void registerBinaryStatus(BinaryStatusApi binaryStatusApi) {
        ...
        codeArea.addEditationModeChangedListener(new EditationModeChangedListener() {
            ...
            public void editationModeChanged(EditationMode editationMode, EditationOperation editationOperation) {
                binaryStatus.setEditationMode(editationMode, editationOperation);
            }
        });
    ...
    private JPopupMenu createContextMenu(int x, int y) {
        ...
        optionsMenuItem.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent e) {
                ...
                final BinEdOptionsPanel optionsPanel = optionsPanelWrapper.getOptionsPanel();
                ...
                final DialogWrapper dialog =
                    WindowUtils.createDialog(dialogPanel, (Component)e.getSource(), "Options", Dialog.ModalityType.APPLICATION_MODAL);
            ...
            default: {
                ...
                aboutMenuItem.addActionListener(new ActionListener() {
                    ...
                    public void actionPerformed(ActionEvent e) {
                        ...
                        final DialogWrapper dialog =
                            WindowUtils.createDialog(dialogPanel, WindowUtils.getWindow(editorPanel), "About Plugin",
