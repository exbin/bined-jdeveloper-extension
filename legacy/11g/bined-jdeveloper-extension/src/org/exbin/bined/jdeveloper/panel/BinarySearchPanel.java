...
//                    hexadecimalRenderer.setMainColors(mainColors);
    ...
    private void initComponents() {
        ...
        findComboBox = new javax.swing.JComboBox<SearchCondition>();
        ...
        replaceComboBox = new javax.swing.JComboBox<SearchCondition>();
    ...
    private void optionsButtonActionPerformed(final java.awt.event.ActionEvent evt) {//GEN-FIRST:event_optionsButtonActionPerformed
        ...
        controlPanel.setHandler(new DefaultControlHandler() {
            public void controlActionPerformed(ControlActionType actionType) {
                if (actionType == DefaultControlHandler.ControlActionType.OK) {
